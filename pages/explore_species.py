...
def build_trail_card(trail, selected_species):
    ...
    trail_card = dbc.Row([
        ...
        dbc.Col([
            html.P(f'{trail_name}', style={'margin-left': '30px', 'text-align': 'justify', 'font-size':'1.1vw', 'color': '#545646', 'font-weight':'bold'}),
            html.P(description, style={'margin-left': '30px', 'text-align': 'justify', 'color':'#545646', 'font-size':'0.9vw'})
        ], width=9),
        dbc.Col([
            dbc.Row([
                dbc.Col([
                    ...
                    html.I(
                        className="fas fa-paw", style={'color': '#808080',  'font-size':'1.1vw','margin-right': '5px', 'margin-top': '20px', 'margin-left': '30px'}),
                    html.Span(f"Species to spot in this trail: {trail_card_species_str}", style={'color': '#808080', 'font-size':'1.1vw','font-weight': 'bold'}),
                    html.Div(""),
                    # Mountain icon

                    html.I(
                        className="fas fa-clock", style={'color': '#808080', 'font-size':'1.1vw','margin-right': '5px', 'margin-top': '20px', 'margin-left': '30px'}),
                    html.Span(f"How long you'll be hiking for: {duration}hours", style={'font-size':'1.1vw','color': '#808080'}),
                    html.Div(""),
                    # Mountain icon

                    html.I(
                        className="fas fa-mountain", style={'font-size':'1.1vw','color': '#808080', 'margin-right': '5px', 'margin-left': '30px', 'margin-top': '15px'}),
                    html.Span(f"How steep it is: {elevation_gain}m", style={'font-size':'1.1vw','color': '#808080'}),
                    html.Div(""),
                    # Route icon

                    html.I(
                        className="fas fa-route", style={'font-size':'1.1vw','color': '#808080', 'margin-right': '5px', 'margin-left': '30px', 'margin-top': '15px'}),
                    html.Span(f" How much distance you're covering: {distance}km", style={'font-size':'1.1vw','color': '#808080'}),

                ], width=12),
                dbc.Col([
                    html.I(className="fas fa-solid fa-car",
                           style={'font-size':'1.1vw','color': '#808080', 'margin-right': '5px',  'margin-left': '30px', 'margin-top': '15px'}),
                    html.Span(f"How long before you should leave from Melbourne: {time_mel}hours", style={'font-size':'1.1vw','color': '#808080'}),
                    html.Div(""),

                    html.I(
                        className="fas fa-map-pin", style={'color': '#808080', 'margin-right': '5px', 'font-size':'1.1vw', 'margin-left': '30px', 'margin-top': '15px'}),
                    html.Span(f"How far it is from Melbourne: {dist_mel}km", style={'font-size':'1.1vw','color': '#808080'}),
                    html.Div(""),

                    html.I(
                        className="fas fa-redo", style={'color': '#808080','font-size':'1.1vw', 'margin-right': '5px',  'margin-left': '30px', 'margin-top': '15px'}),
                    html.Span(f"Will you come back to the same place you parked: {looped}", style={'font-size':'1.1vw','color': '#808080'}),
                ], width=12),
...
layout = html.Div([
    ...
    dbc.Container(children=[
        ...
        html.P(
            ...
            className="lead", style={"padding": "5%", "font-size": "1.3vw", 'text-align':'center', 'color':'#545646'}
        ),
        dbc.Button("Customize your Trail", id="next-to-species", color="primary", className="d-block mx-auto", style={"font-size": "1.2vw",'text-decoration': 'none', 'padding': '5px 15px', 'background': '#545646', 'color': '#F9F1E8', 'border-radius': '20px', 'margin-top':'0%'}),
    ...
    dbc.Container(children=[
        ...
        dbc.Button("Next: Difficulty Level >", id="next-to-difficulty", className="d-block mx-auto",
                   style={"font-size": "1.2vw",'text-decoration': 'none', 'padding': '6px 15px', 'background': '#545646', 'color': '#F9F1E8', 'border-radius': '20px', 'margin-top':'5%'}),
    ...
    dbc.Container(children=[
        html.H3("How much do you want to challenge yourself?", className='text-center', style={"font-size": "1.2vw",'color':'#545646'}),
        dcc.RadioItems(
            options=[
            ...
            style={'margin-left':'35%', 'margin-top':'5%', 'margin-bottom':'5%', "font-size": "1.2vw", 'color':'#545646'}
        ),
        dbc.Row([
            dbc.Col(dbc.Button("< Back: Species", id="back-to-species", color="primary", className="d-block mx-auto", style={"font-size": "1.2vw",'text-decoration': 'none', 'padding': '6px 15px', 'background': '#545646', 'color': '#F9F1E8', 'border-radius': '20px', 'margin-top':'0%'}), width="auto"),
            dbc.Col(dbc.Button("Next: Duration of Hike >", id="next-to-duration", color="primary", className="d-block mx-auto", style={"font-size": "1.2vw",'text-decoration': 'none', 'padding': '6px 15px', 'background': '#545646', 'color': '#F9F1E8', 'border-radius': '20px', 'margin-top':'0%'}), width="auto")
    ...
    dbc.Container(children=[
        html.H3("For how long do you want to hike?", className='text-center', style={"font-size": "1.2vw",'color':'#545646'}),
        dcc.RadioItems(
            options=[
            ...
            id='duration-radio',
            labelStyle={"fontSize": "0.85em", 'color':'#716233'},
            style={'margin-left':'35%', 'margin-top':'5%', 'margin-bottom':'5%', "font-size": "1.2vw"}
        ),
        dbc.Row([
            dbc.Col(dbc.Button("< Back: Difficulty", id="back-to-difficulty", color="primary", className="d-block mx-auto", style={"font-size": "1.2vw",'text-decoration': 'none', 'padding': '6px 15px', 'background': '#545646', 'color': '#F9F1E8', 'border-radius': '20px', 'margin-top':'0%'}), width="auto"),
            dbc.Col(dbc.Button("Next: Distance from Melbourne >", id="next-to-dist-mel", color="primary", className="d-block mx-auto", style={"font-size": "1.2vw",'text-decoration': 'none', 'padding': '6px 15px', 'background': '#545646', 'color': '#F9F1E8', 'border-radius': '20px', 'margin-top':'0%'}), width="auto")
        ], justify="center", className="my-4"),
    ...
    dbc.Container(children=[
        html.H3("How far you are willing to travel", className='text-center', style={"font-size": "1.2vw", 'color':'#545646'}),
        dcc.RadioItems(
            options=[
        ...
        dbc.Row([
            dbc.Col(dbc.Button("< Back: Duration", id="back-to-duration", color="primary", className="d-block mx-auto", style={"font-size": "1.2vw",'text-decoration': 'none', 'padding': '6px 15px', 'background': '#545646', 'color': '#F9F1E8', 'border-radius': '20px', 'margin-top':'0%'}), width="auto"),
            dbc.Col(dbc.Button("Recommend Hikes!", id="finish-quiz", color="primary", className="d-block mx-auto", style={"font-size": "1.2vw",'text-decoration': 'none', 'padding': '6px 15px', 'background': '#545646', 'color': '#F9F1E8', 'border-radius': '20px', 'margin-top':'0%'}), width="auto")
        ], justify="center", className="my-4"),
    ...
    dbc.Container(children=[
        dbc.Button("< Get new recommendations", id="new-recomm", color="primary", style={"font-size": "1.2vw",'text-decoration': 'none', 'padding': '6px 15px', 'background': '#545646', 'color': '#F9F1E8', 'border-radius': '20px', 'margin-top':'0%'}),
        html.H3(id='text-result', children="Loading...", style={'font-size':'1.2vw', 'text-align':'left', 'margin-top':'5%', 'margin-bottom':'5%', 'color':'#545646'}),
...
def update_species_cards(selected_species):
    ...
    return [
            dbc.Card([
                ...
                dbc.CardImg(src=b64_image(f"data/species/{species.replace(' ', '_')}.jpg"), top=True, style={'width': '80%', 'height': '70%', 'object-fit': 'cover', 'margin-top':'5%', 'margin-left':'12%'}),
                dbc.CardBody([
...
def display_results(n_clicks, selected_species, selected_difficulty, selected_duration, selected_distance):
    ...
    # Create buttons
    button_go_to_my_trails = dbc.Col(dbc.Button("Start the trail that intruiged you", href="/my-trails", color="primary", className="d-block mx-auto", style={'font-size': '1.2vw','text-decoration': 'none', 'padding': '6px 15px', 'background': '#545646', 'color': '#F9F1E8', 'border-radius': '20px', 'margin-top':'0%'}), width="auto")
    button_see_events = dbc.Col(dbc.Button("View other events you can participate in",  href="/events", color="primary", className="d-block mx-auto", style={'font-size': '1.2vw','text-decoration': 'none', 'padding': '6px 15px', 'background': '#545646', 'color': '#F9F1E8', 'border-radius': '20px', 'margin-top':'0%'}), width="auto")
    button_row = dbc.Row(
        [
            dbc.Col(button_go_to_my_trails, width="auto"),
            dbc.Col(button_see_events, width="auto")
        ],
        justify="center",
        className="my-4"
    )
