...
layout = dbc.Container(fluid=True, children=[
    ...
    html.Section(className='parallax', 
        ...
        dbc.Row([
            dbc.Col([
                html.Div(style={
                    'backgroundImage': f'url({b64_image("assets/all_trails_bg.png")})',
                ...
                dbc.Col([
                    html.Div([
                        html.P('Find species on your trail', style={'font-size': '3.5vw', 'color': '#47483c', 'margin-left':'20%'}),
                        ...
                        html.P(" "),
                        html.H4("Get real time updates on species found on your trail. Let's share interesting wildlife we find around Victoria.", style={'font-size': '1.4vw','color': '#545646', 'text-align':'left', 'margin-left':'25%', 'padding':'5%'}),
                        ...
                        dcc.Link(html.Button([
                                "Don't know which trail?",
                                html.Br(),
                                "Let us recommend one to you"
                            ], n_clicks=0, style={'fontSize': '1.3vw','text-decoration': 'none', 'padding': '6px 15px', 'background': '#545646', 'color': '#F9F1E8', 'border-radius': '20px', 'margin-top':'10%', 'margin-left': '36%',}), 
